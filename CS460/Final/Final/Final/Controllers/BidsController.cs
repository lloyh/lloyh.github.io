...
namespace Final.Controllers
{
    public class BidsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BidID,ItemID,BuyerID,Price,BidDate")] Bid bid)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BidID,ItemID,BuyerID,Price,BidDate")] Bid bid)
        {
            if (ModelState.IsValid)
            {
